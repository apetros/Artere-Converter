...
Transformer = pp.create_transformer_from_parameters(net, hv_bus=SubstationMVbus, lv_bus=SubstationLVbus, name="Dyn11",
                                                    sn_mva=630, vn_hv_kv=11, vn_lv_kv=0.433,
                                                    ...
                                                    tap_pos=5, mag0_rx=4.558264, mag0_percent=1.51942)
...
lineP17 = pp.create_line(net, from_bus=bus51, to_bus=bus51_2, name="lineP17", length_km=0.020,
                         std_type="LV Overhead 14mm", in_service=True)
lineP18 = pp.create_line(net, from_bus=bus52, to_bus=bus512_1, name="lineP18", length_km=0.020,
                         std_type="LV Overhead 14mm", in_service=True)
lineP19 = pp.create_line(net, from_bus=bus52, to_bus=bus512_2, name="lineP19", length_km=0.020,
                         std_type="LV Overhead 14mm", in_service=True)
